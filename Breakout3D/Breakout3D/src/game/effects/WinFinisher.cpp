/**
 * @file WinFinisher.cpp
 * @brief Efeitos “cinemáticos” do fim de nível (modo Normal): shake/roll/FOV + overlay (flash + ring).
 *
 * @details
 *  - computeWinFinisherCamera(): gera uma câmara temporária com shake determinístico,
 *    “FOV punch” e roll sincronizados com o tempo cinemático.
 *  - computeWinFinisherOverlay(): projeta o ponto âncora para ecrã e calcula flash/ring.
 *
 * @note
 *  - O efeito usa finisherCineTimeSec para manter sincronização entre câmara e UI.
 *  - Se a âncora não for válida, usa um centro “seguro” perto do meio do ecrã.
 */
